...
function FileItem({ file }) {
  ...
  return (
    <li
      className={`p-2 flex items-center cursor-pointer transition-all duration-100 ${
    ...
    >
      ...
      <svg
        className={`w-5 h-5 mr-3 flex-shrink-0 transition-colors duration-100 ${
      ...
      <span
        className={`
        truncate flex-grow transition-colors duration-100
